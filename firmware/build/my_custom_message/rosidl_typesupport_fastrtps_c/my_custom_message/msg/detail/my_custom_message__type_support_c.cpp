...
bool cdr_serialize_my_custom_message__msg__MyCustomMessage(
  const my_custom_message__msg__MyCustomMessage * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_custom_message
bool cdr_deserialize_my_custom_message__msg__MyCustomMessage(
  eprosima::fastcdr::Cdr & cdr,
  my_custom_message__msg__MyCustomMessage * ros_message)
{
  // Field name: bool_test
  {
    uint8_t tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_custom_message
bool cdr_serialize_key_my_custom_message__msg__MyCustomMessage(
  const my_custom_message__msg__MyCustomMessage * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: bool_test
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_custom_message
size_t get_serialized_size_key_my_custom_message__msg__MyCustomMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MyCustomMessage__ros_msg_type * ros_message = static_cast<const _MyCustomMessage__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_custom_message
size_t max_serialized_size_key_my_custom_message__msg__MyCustomMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const my_custom_message__msg__MyCustomMessage * ros_message = static_cast<const my_custom_message__msg__MyCustomMessage *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_my_custom_message__msg__MyCustomMessage(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  my_custom_message__msg__MyCustomMessage * ros_message = static_cast<my_custom_message__msg__MyCustomMessage *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_my_custom_message__msg__MyCustomMessage(cdr, ros_message);
}
