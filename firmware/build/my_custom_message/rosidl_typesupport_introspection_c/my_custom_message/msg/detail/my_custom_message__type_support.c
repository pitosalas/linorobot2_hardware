...
static rosidl_typesupport_introspection_c__MessageMember my_custom_message__msg__MyCustomMessage__rosidl_typesupport_introspection_c__MyCustomMessage_message_member_array[13] = {
  {
    "bool_test",  // name
    ...
    offsetof(my_custom_message__msg__MyCustomMessage, bool_test),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_custom_message__msg__MyCustomMessage, byte_test),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_custom_message__msg__MyCustomMessage, char_test),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_custom_message__msg__MyCustomMessage, float32_test),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_custom_message__msg__MyCustomMessage, double_test),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
